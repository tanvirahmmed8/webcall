(function () {
  ...
  function initSpeaklarFunctions() {
    ...
    window.speaklarCall = function () {
      ...
      session.on("accepted", () => {
        ...
        // const audioVisualizer = document.querySelector(
        //   `.${WIDGET_NAMESPACE}-audio-visualizer`
        // );
        // if (audioVisualizer) {
  ...
  //     // Get audio bars
  //     const audioBars = document.querySelectorAll(
  //       `.${WIDGET_NAMESPACE}-audio-bar`
  //     );
  ...
  //       visualizationAnimationFrame = requestAnimationFrame(animateBars);
  ...
  //     // audioBars = document.querySelectorAll(`.${WIDGET_NAMESPACE}-audio-bar`);

  //     isCallActive = true; // ✅ Start animation
  //     // animateBars();
  //   } catch (error) {
  //     console.error("Error setting up audio visualization:", error);
  //   }
  ...
  // function animateBars() {
  //   if (!isCallActive) return; // ✅ Stop animation when call not active
