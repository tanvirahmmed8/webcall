(function () {
  ...
  :root {
    --primary-gradient: linear-gradient(30deg, #b50000 0%, #b50000 114%);
    --secondary-gradient: linear-gradient(135deg, #b50000, #b50000);
    --primary-bg-color: #b50000;
    --secondary-bg-color: #b50000;
  ...
  #${WIDGET_NAMESPACE}-popup {
    ...
    width: 280px;
    background: linear-gradient(30deg, #b50000 0%, #b50000 180%);
  ...
  #${WIDGET_NAMESPACE}-volume-controller {
    ...
    top: 9px;
    left: 10px;
    background: linear-gradient(30deg, #b50000 0%, #b50000 114%);
  ...
  .${WIDGET_NAMESPACE}-audio-ring {
    ...
    border-radius: var(--border-radius-circle);
    border: 2px solid rgba(181, 0, 0, 0.7);
  ...
  function register() {
    ...
    var sipUser = "50003";
    var sipPassword = "ln47UEwtayNHyzd";
  ...
  window.adjustVolume = function (value) {
    ...
    const volumeSlider = document.getElementById(`${WIDGET_NAMESPACE}-volume-slider`);
    if (volumeSlider) {
  ...
  function createPopup() {
    ...
    toggleButton.innerHTML = `
         <div style="display: flex; align-items: center;">
          ...
          <div style="display: flex; align-items: center; border-left: 1px solid rgba(255,255,255,0.3); padding-left: 10px; background: white; color: black; padding: 8px 8px; border-radius: 15px;">
            <img src="https://flagcdn.com/w40/bd.png" style="width: 20px; height: 20px; border-radius: 50%;">
    ...
    additionalStyle.textContent = `
          ...
          #${WIDGET_NAMESPACE}-avatar {
            ...
            height: 120px;
            border: none;
            box-shadow: 0 0 20px rgba(181, 0, 0, 0.7);
            margin: 25px auto 15px auto;
            position: relative;
            border-radius: 50%;
            object-fit: cover;
    ...
    popup.innerHTML = `
      ...
      <div id="step-call" class="${WIDGET_NAMESPACE}-step ${WIDGET_NAMESPACE}-active">
        ...
        <div class="${WIDGET_NAMESPACE}-call-controls" style="display: flex; justify-content: space-between; margin-top: 15px;">
          <!-- Audio visualizer -->
          <div class="${WIDGET_NAMESPACE}-audio-visualizer" style="display: flex; background: white; color: black; padding: 4px 8px; border-radius: 15px; margin-right: 12px;">
            <div class="${WIDGET_NAMESPACE}-audio-bar"></div>
            <div class="${WIDGET_NAMESPACE}-audio-bar"></div>
            <div class="${WIDGET_NAMESPACE}-audio-bar"></div>
            <div class="${WIDGET_NAMESPACE}-audio-bar"></div>
          </div>
          ...
          <div class="${WIDGET_NAMESPACE}-language-dropdown">
            <img id="${WIDGET_NAMESPACE}-current-language-flag" src="https://flagcdn.com/w40/bd.png" class="${WIDGET_NAMESPACE}-language-flag" alt="Language">
    ...
    const volumeToggle = document.getElementById(`${WIDGET_NAMESPACE}-volume-toggle`);
    const volumeController = document.getElementById(`${WIDGET_NAMESPACE}-volume-controller`);
    ...
    if (volumeToggle) {
      volumeToggle.addEventListener('click', function() {
        ...
        if (volumeController.classList.contains(`${WIDGET_NAMESPACE}-collapsed`)) {
